...
urlpatterns = [
    ...
    # Canonical DRF OpenAPI docs. DRF uses drf-spectacular AutoSchema in
    # settings, so these routes exercise the same serializer/schema pipeline
    # used by production API documentation. The drf-yasg root stays available
    # temporarily as a legacy compatibility bridge.
