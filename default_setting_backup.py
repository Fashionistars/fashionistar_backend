...
#         "LOCATION": f"redis://{REDIS_HOST}:{REDIS_PORT}/{REDIS_DB}",  # Or use REDIS_URL
#         "OPTIONS": {
...
#         'LOCATION': 'redis://127.0.0.1:6379/1',  # Replace with your Redis server
#         'OPTIONS': {
#             'CLIENT_CLASS': 'django_redis.client.DefaultClient',
#         }
#     }
...
CELERY_BROKER_URL = config('CELERY_BROKER_URL', default='redis://localhost:6379/0') # Redis broker
...
DEFAULT_FROM_EMAIL = config('DEFAULT_FROM_EMAIL', default='youremail@gmail.com')  # Add this line
