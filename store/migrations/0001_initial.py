    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('buyer', models.ForeignKey(blank=True, help_text='Buyer associated with the cart order', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='buyer', to=settings.AUTH_USER_MODEL)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.ManyToManyField(related_name='products', to='admin_backend.category')),
                ('vendor', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='vendor_role', to='vendor.vendor')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.ForeignKey(default='', on_delete=django.db.models.deletion.PROTECT, to='admin_backend.category', verbose_name='Category')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('coupon', models.ManyToManyField(blank=True, help_text='Coupons applied to the order item', to='store.coupon')),
                ('delivery_couriers', models.ForeignKey(blank=True, help_text='Courier service used for delivery', null=True, on_delete=django.db.models.deletion.SET_NULL, to='store.deliverycouriers')),
                ('order', models.ForeignKey(help_text='Cart order associated with the order item', on_delete=django.db.models.deletion.CASCADE, related_name='orderitem', to='store.cartorder')),
                ('product', models.ForeignKey(help_text='Product associated with the order item', on_delete=django.db.models.deletion.CASCADE, related_name='order_item', to='store.product')),
                ('vendor', models.ForeignKey(help_text='Vendor associated with the order item', null=True, on_delete=django.db.models.deletion.SET_NULL, to='vendor.vendor')),
            ],
            options={
