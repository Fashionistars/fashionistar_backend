...
class TestOrderIdempotency:
    ...
    def test_create_order_twice_same_key_returns_one_record(self, user, db):
    ...
    def test_idempotency_key_unique_constraint_enforced(self, user, db):
...
class TestOrderGiftIdempotency:
    ...
    def test_gift_message_preserved(self, user, db):
        from apps.order.models import Order
...
class TestOrderSustainabilityIdempotency:
    ...
    def test_carbon_offset_not_reset(self, user, db):
        from apps.order.models import Order
