...
class WalletEscrowServiceTests(TestCase):
    ...
    @patch("apps.kyc.services.kyc_service.assert_kyc_approved")
    def test_wallet_pin_and_transfer_create_ledger_entry(self, mock_assert_kyc_approved):
        ...
        mock_assert_kyc_approved.assert_called_once_with(self.client_user)
