...
Endpoints:
  ...
  GET    /api/v1/notifications/<id>/         — Detail only
  POST   /api/v1/notifications/mark-read/<id>/ — Mark one notification read
...
class NotificationDetailView(APIView):
    ...
    Returns a single notification without mutating read state.
    """
    renderer_classes = _RENDERERS
    permission_classes = [IsAuthenticated, IsAuthenticatedAndActive]
