        ...
        *   *Request Body:* None
        ...
        def get_queryset(self):
            ...
            try:
                ...
                return [summary_object]  # Wrap the single dictionary in a list
        ...
        def get_product_count(self, user):
            ...
            """
            vendor_obj = fetch_user_and_vendor(user)
            return Product.objects.filter(vendor=vendor_obj, in_stock=False).count()
        ...
        def get_order_count(self, user):
            ...
            """
            vendor_obj = fetch_user_and_vendor(user)
            return CartOrder.objects.filter(vendor=vendor_obj, payment_status="paid").count()
        ...
        def calculate_revenue(self, user):
            ...
            """
            vendor_obj = fetch_user_and_vendor(user)
            total_revenue = CartOrderItem.objects.filter(vendor=vendor_obj, order__payment_status="paid").aggregate(
        ...
        def get_review_count(self, user):
            ...
            """
            vendor_obj = fetch_user_and_vendor(user)
            vendor_product_ids = Product.objects.filter(vendor=vendor_obj).values_list('id', flat=True)
        ...
        def calculate_average_order_value(self, user):
            ...
            """
            vendor_obj = fetch_user_and_vendor(user)
            average_order_value = CartOrder.objects.filter(vendor=vendor_obj, payment_status="Fulfilled").aggregate(
        ...
        def calculate_total_sales(self, user):
            ...
            """
            vendor_obj = fetch_user_and_vendor(user)
            total_sales = CartOrder.objects.filter(vendor=vendor_obj, payment_status="paid").aggregate(
