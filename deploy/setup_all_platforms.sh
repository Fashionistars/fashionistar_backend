...
echo "     URL: https://fashionistar-fashionistar-api.hf.space"
echo "     Health: https://fashionistar-fashionistar-api.hf.space/api/v1/health/"
echo "     Status: https://huggingface.co/spaces/fashionistar/fashionistar-api"
echo ""
